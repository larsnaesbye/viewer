...
public:
    ...
    {
        LLToggleableMenu::handleDragAndDrop(x, y, mask, drop, cargo_type, cargo_data, accept, tooltip_msg);
        return TRUE;
    }
...
bool LLFavoritesBarCtrl::handleDragAndDropToMenu(LLUICtrl* ctrl, S32 x, S32 y, MASK mask, BOOL drop,
    EDragAndDropType cargo_type, void* cargo_data, EAcceptance* accept, std::string& tooltip_msg)
{
...
void LLFavoritesBarCtrl::createOverflowMenu()
{
	...
	menu->setDragAndDropCallback([this](LLUICtrl* ctrl, S32 x, S32 y, MASK mask, BOOL drop,
		EDragAndDropType cargo_type, void* cargo_data, EAcceptance* accept, std::string& tooltip_msg) -> bool
		{
			return handleDragAndDropToMenu(ctrl, x, y, mask, drop, cargo_type, cargo_data, accept, tooltip_msg);
		});
}
